    ...
    <div class="flex flex-col lg:flex-row gap-8">
        ...
        <div class="w-full lg:w-2/3">
            ...
            <div class="text-sm text-gray-500 mb-6 flex items-center space-x-2">
                ...
                <span class="text-gray-800 font-medium">{{ $title ?? 'Tambah Konsultasi' }}</span>
            </div>

            <h2 class="text-3xl font-bold text-gray-900 mb-8 pb-3 border-b-2 border-green-600 inline-block">{{ $title ?? 'Tambah Konsultasi' }}</h2>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden mb-8">
                <div class="p-6 sm:p-8">
                    <form action="{{ url('user/konsultasi_tambah') }}" enctype="multipart/form-data" method="POST" class="space-y-6">
                        @csrf
                        ...
                        <div>
                            ...
                            <input type="text" name="b" class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-green-500 focus:border-green-500 text-sm" required>
                        </div>

                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Deskripsi <span class="text-red-500">*</span></label>
                            <textarea name="h" rows="6" class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-green-500 focus:border-green-500 text-sm textarea" required></textarea>
                        </div>
                        ...
                        <div class="mt-8 pt-6 border-t border-gray-200 flex flex-col sm:flex-row gap-3">
                            <button type="submit" name="submit" class="bg-green-600 hover:bg-green-700 text-white font-bold py-2.5 px-6 rounded-md shadow-sm transition-colors">
                                <i class="fa-solid fa-paper-plane mr-2"></i> Kirimkan
                            </button>
                            <button type="reset" class="bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold py-2.5 px-6 rounded-md shadow-sm transition-colors text-center">
                                <i class="fa-solid fa-rotate-right mr-2"></i> Batal
                            </button>
