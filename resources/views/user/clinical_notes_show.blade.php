...
<div class="w-full bg-[#F9F9FF] font-['Inter'] min-h-screen">
    <div class="max-w-[800px] mx-auto py-12 px-4 md:px-0">
        ...
        <div class="mb-6 flex justify-between items-end">
            <div>
                <a href="{{ route('user.clinical_notes.index') }}" class="text-[#002045] text-sm hover:underline mb-2 inline-block">&larr; Kembali ke Daftar Catatan</a>
                <h1 class="text-3xl font-bold text-[#111C2C]">Detail Catatan Klinis</h1>
            </div>
            <div class="flex gap-2">
                <button onclick="window.print()" class="bg-[#002045] hover:bg-[#001530] text-white px-4 py-2 rounded-lg transition-colors shadow-sm">
                    <i class="fa-solid fa-download mr-2"></i> Download PDF / Print
                </button>
            </div>
        </div>
        ...
        <div class="bg-white border border-[#C4C6CF] rounded-xl shadow-sm overflow-hidden" id="print-area">
            <div class="p-8 border-b border-[#E1E6F3] bg-[#F9F9FF] flex justify-between items-start">
                <div>
                    ...
                    <p class="text-[#43474E] mt-1 text-sm">Dokumen Rahasia - Dokumen Pribadi Pasien</p>
                </div>
            ...
            <div class="bg-gray-50 px-8 py-4 border-t border-[#C4C6CF] text-xs text-center text-[#43474E]">
                Dokumen ini dicetak pada {{ date('d/m/Y H:i') }}.
            </div>
        </div>
    </div>
</div>
